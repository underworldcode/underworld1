...
void _CartesianGenerator_AssignFromXML( void* meshGenerator, Stg_ComponentFactory* cf, void* data ) {
   ...
   context = Stg_ComponentFactory_ConstructByName( cf, (Name)"context", AbstractContext, True, data  ) ;
	...
	/* very rough implementation to set mesh isRegular flag.
	   Once we sort a simple method for data/method inheritance this'll be cleaned up, JG 31Jan13 */ 
	self->meshes[0]->isRegular = self->regular;
