...
#ifndef __Underworld_Utils_MatrixAssemblyTerm_NA__NB__F_h__
#define __Underworld_Utils_MatrixAssemblyTerm_NA__NB__F_h__

   /** Textual name of this class */
   extern const Type MatrixAssemblyTerm_NA__NB__F_Type;

   /** MatrixAssemblyTerm_NA__NB__F class contents */
   #define __MatrixAssemblyTerm_NA__NB__F \
      /* General info */ \
      __StiffnessMatrixTerm \
      \
      /* Virtual info */ \
      \
      /* MatrixAssemblyTerm_NA__NB__F info */ \
      PpcManager* ppcManager; \
      Stream*     errorStream; \
      int         functionLabel;

   struct MatrixAssemblyTerm_NA__NB__F { __MatrixAssemblyTerm_NA__NB__F };

   #ifndef ZERO
   #define ZERO 0
   #endif

   #define MATRIXASSEMBLYTERM_NA__NB__F_DEFARGS \
                STIFFNESSMATRIXTERM_DEFARGS

   #define MATRIXASSEMBLYTERM_NA__NB__F_PASSARGS \
