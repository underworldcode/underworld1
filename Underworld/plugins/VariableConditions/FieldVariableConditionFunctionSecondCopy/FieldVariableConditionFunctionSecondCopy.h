...
#ifndef __Underworld_FieldVariableConditionFunctionSecondCopy_h__
#define __Underworld_FieldVariableConditionFunctionSecondCopy_h__

extern const Type FieldVariableConditionFunctionSecondCopy_Type;
