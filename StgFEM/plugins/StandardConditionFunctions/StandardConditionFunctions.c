...
void _StgFEM_StandardConditionFunctions_AssignFromXML( void* component, Stg_ComponentFactory* cf, void* data ) {
   ...
   condFunc = ConditionFunction_New(
      StgFEM_StandardConditionFunctions_SolidBodyRotation,
      (Name)"Velocity_SolidBodyRotation", NULL );
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New(
      StgFEM_StandardConditionFunctions_PartialRotationX,
      (Name)"Velocity_PartialRotationX", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
      
   condFunc = ConditionFunction_New(
      StgFEM_StandardConditionFunctions_PartialRotationY,
      (Name)"Velocity_PartialRotationY", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_TaperedRotationX, (Name)"TaperedRotationX", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
      
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_TaperedRotationY, (Name)"TaperedRotationY", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SimpleShear, (Name)"Velocity_SimpleShear", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SimpleShearInverted, (Name)"Velocity_SimpleShearInverted", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ShearZ, (Name)"ShearZ", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_Extension, (Name)"Velocity_Extension", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_PartialLid_TopLayer, (Name)"Velocity_PartialLid_TopLayer", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_Trigonometry, (Name)"Temperature_Trigonometry", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_LinearInterpolationLid, (Name)"Velocity_LinearInterpolationLid", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_Lid_RampWithCentralMax, (Name)"Velocity_Lid_RampWithCentralMax", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_LinearVelocityLeftWall, (Name)"LinearVelocityLeftWall", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_LinearVelocityRightWall, (Name)"LinearVelocityRightWall", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SinusoidalLid, (Name)"Velocity_SinusoidalLid", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SinusoidalTimeDependent, (Name)"Velocity_SinusoidalTimeDependent", NULL );
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SineInTime, (Name)"SineInTime", NULL );
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_CornerOnly, (Name)"Velocity_Lid_CornerOnly", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_TemperatureCosineHill, (Name)"Temperature_CosineHill", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ConvectionBenchmark, (Name)"Temperature_ConvectionBenchmark", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_LinearWithSinusoidalPerturbation, (Name)"LinearWithSinusoidalPerturbation", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_Linear, (Name)"TemperatureLinear", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_EdgeDriveConvectionIC, (Name)"EdgeDriveConvectionIC", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ThermalEdgeDriveConvectionIC, (Name)"ThermalEdgeDriveConvectionIC", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_AnalyticalTemperatureIC, (Name)"AnalyticalTemperatureIC", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( Stg_FEM_VelicTemperatureIC, (Name)"VelicTemperatureIC", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( Stg_FEM_VelicTemperatureIC_SolB, (Name)"VelicTemperatureIC_SolB", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );
   
   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SinusoidalExtension, (Name)"SinusoidalExtension", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_StepFunction, (Name)"StepFunction", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StG_FEM_StandardConditionFunctions_StepFunctionProduct1, (Name)"StepFunctionProduct1", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StG_FEM_StandardConditionFunctions_StepFunctionProduct2, (Name)"StepFunctionProduct2", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StG_FEM_StandardConditionFunctions_StepFunctionProduct3, (Name)"StepFunctionProduct3", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StG_FEM_StandardConditionFunctions_StepFunctionProduct4, (Name)"StepFunctionProduct4", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_TemperatureProfile, (Name)"TemperatureProfile", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StG_FEM_StandardConditionFunctions_Gaussian, (Name)"Gaussian", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New(StgFEM_StandardConditionFunctions_ERF, (Name)"ERF", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New(StgFEM_StandardConditionFunctions_ERFC, (Name)"ERFC", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New(StgFEM_StandardConditionFunctions_RubberSheet, (Name)"RubberSheet", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_MovingStepFunction, (Name)"MovingStepFunction", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpecRidge3D, (Name)"SpecRidge3D", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpectralBCX, (Name)"SpectralBCX", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpectralBCY, (Name)"SpectralBCY", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpectralBCZ, (Name)"SpectralBCZ", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpectralPressureBCX, (Name)"SpectralPressureBCX", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SpectralPressureBCY, (Name)"SpectralPressureBCY", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ErrorFunc, (Name)"ErrorFunc", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ConstantVector, (Name)"ConstantVector", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_GaussianDistribution, (Name)"GaussianDistribution", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_1DGaussianDistribution, (Name)"1DGaussianDistribution", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_HalfContainer, (Name)"HalfContainer", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_ConstantValue, (Name)"ConstantValue", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_DiagonalLine, (Name)"DiagonalLine", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_DeltaFunction, (Name)"DeltaFunction", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_InflowBottom, (Name)"InflowBottom", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_GaussianTube, (Name)"GaussianTube", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_GravitationalPotential, (Name)"GravitationalPotential", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_TimestepHeating, (Name)"TimestepHeating", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New( StgFEM_StandardConditionFunctions_SinusoidalY, (Name)"SinusoidalY", NULL);
   ConditionFunction_Register_Add( condFunc_Register, condFunc );

   condFunc = ConditionFunction_New(
      StgFEM_StandardConditionFunctions_TimeLimitedExtension,
...
void StgFEM_StandardConditionFunctions_PartialLid_TopLayer( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   ...
   FeMesh*         mesh = NULL;
   double*         velResult = (double*)_result;
   double                  margin = 0;
   double         min[3], max[3];
...
void StgFEM_StandardConditionFunctions_SinusoidalTimeDependent( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
	...
	FeMesh*			feMesh = NULL;
	double*        velResult = (double*)_result;
	double         A,B,C,D,E, *coord;

	A = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"SinusoidalTimeDependent_A", 1 );
	B = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"SinusoidalTimeDependent_B", 2*M_PI );
	C = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"SinusoidalTimeDependent_C", 0 );
	D = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"SinusoidalTimeDependent_D", 0 );
	E = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"SinusoidalTimeDependent_E", 0 );

   velVar = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "VelocityField" );
	feMesh = velVar->feMesh;
   coord = Mesh_GetVertex( feMesh, node_lI );

	*velResult = A*sin(B*coord[1]+C*context->timeStep+D) + E;
}
...
void StgFEM_StandardConditionFunctions_SineInTime( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   DomainContext*  context = (DomainContext*)_context;
   double*         tempResult = (double*)_result;
   double          frequency;
   double          amplitude;
   double          offset;

   frequency = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"Frequency", 1 );
   amplitude = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"Amplitude", 0.5 );
   offset    = Dictionary_GetDouble_WithDefault( context->dictionary, (Dictionary_Entry_Key)"Offset", 1 );
   
   (*tempResult) = offset + amplitude*sin( 2. * M_PI * frequency * context->currentTime );
}
...
void StgFEM_StandardConditionFunctions_LinearWithSinusoidalPerturbation( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   ...
   double         pertCoeff;
   unsigned       vertaxis = Dictionary_GetUnsignedInt_WithDefault( dictionary, (Dictionary_Entry_Key)"VerticalAxis", 1 );
...
void StgFEM_StandardConditionFunctions_Linear( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   ...
   topLayerCoord = Dictionary_GetDouble_WithScopeDefault( dictionary, (Dictionary_Entry_Key)"LinearTempIC_TopLayerCoord", max[vertaxis] );
   bottomLayerCoord = Dictionary_GetDouble_WithScopeDefault( dictionary, (Dictionary_Entry_Key)"LinearTempIC_BottomLayerCoord", min[vertaxis] );
   topLayerBC = Dictionary_GetDouble_WithScopeDefault( dictionary, (Dictionary_Entry_Key)"LinearTempIC_TopLayerBC", 0.0 );
   bottomLayerBC = Dictionary_GetDouble_WithScopeDefault( dictionary, (Dictionary_Entry_Key)"LinearTempIC_BottomLayerBC", 1.0 );
   scaleFactor = bottomLayerBC - topLayerBC;
   ...
   /* make coord relative to box bottom left corner, then scale from 0 to 1 between box min & max */
   relScaledCoord = (coord[vertaxis] - bottomLayerCoord) / (topLayerCoord - bottomLayerCoord);

   *result = topLayerBC + scaleFactor * (1.0 - relScaledCoord);
...
void StgFEM_StandardConditionFunctions_StepFunction( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   ...
   /* comment out in GALE merge, JG, 13Sep10
   double         left;
   double         right;
   double         grad;
   Bool         useGrad;
...
void StgFEM_StandardConditionFunctions_TemperatureProfile( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
  ...
  double*                 result             = (double*) _result;
  double*                 coord;
  double                  T_0, H_0, dH, H, H_m, A, B, C, x_min, x_max, top, T_m, xc, dum;
  unsigned       vertaxis = Dictionary_GetUnsignedInt_WithDefault( dictionary, (Dictionary_Entry_Key)"VerticalAxis", 1 );
  ...
  if(vertaxis == 1)
     top = Dictionary_GetDouble_WithDefault( dictionary, "maxY", 0.0 );
  else
     top = Dictionary_GetDouble_WithDefault( dictionary, "maxZ", 0.0 );
  ...
  if (H_0<0.0)
    {
      if(coord[vertaxis]>top)
        {
          *result=T_0;
        }
      else
        {
          *result=T_0 + A*(top-coord[vertaxis]) + B*(1-exp(-C*(top-coord[vertaxis])));
        }
    }
  else
    {
      if(coord[vertaxis]>=top)
      ...
      else
        {
          ...
          dum=T_0 + ((T_m-T_0)/H)*(top-coord[vertaxis])
            + B*(1-exp(-C*(top-coord[vertaxis])));
          if (dum>T_m) dum=T_m;
          *result=dum;
        }
    }
...
void StgFEM_StandardConditionFunctions_ERFC(Node_LocalIndex node_lI,
                                            ...
                                            void* _context, void* _data, void* _result ) {
   FiniteElementContext *   context            = (FiniteElementContext*)_context;
   FeVariable*             feVariable         = NULL;
   FeMesh*         feMesh               = NULL;
   Dictionary*             dictionary         = context->dictionary;
...
void StgFEM_StandardConditionFunctions_GaussianTube( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
   ...
   /* Asymmetric gaussian tube... factors multiply smoothing length in respective dimensions */
   y_smooth = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"GaussianTube_y_smoothFactor", 1.0 );
   z_smooth = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"GaussianTube_z_smoothFactor", 1.0 );
   ...
   if (nDims==3) {
      ...
      b1 = a2 * sin( b2*x - c2 );
      r_yz = sqrt( (y-b1)*(y-b1)/(y_smooth*y_smooth) + z*z/(z_smooth*z_smooth) );
...
void StgFEM_StandardConditionFunctions_TimestepHeating( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
	...
	feVariable = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "TemperatureField" );
        *result = (double)context->timeStep;
}
...
void StgFEM_StandardConditionFunctions_SinusoidalY( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* _data, void* _result ) {
	...
	double*                 result             = (double*) _result;
        FeMesh* feMesh;
	double*			coord, origin, wl;

	wl = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"SinusoidalY_WaveLength", 1.0  );
	origin = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"SinusoidalY_Origin", 0.0  );

	feVariable = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "TemperatureField" );
        feMesh       = feVariable->feMesh;
        coord = Mesh_GetVertex( feMesh, node_lI );
        *result = sin((coord[1] - origin)*2.0*M_PI/wl);
}
   ...
   void* _data, void* _result )
{
    ...
    endTime = Dictionary_GetDouble_WithDefault(
        dictionary, (Dictionary_Entry_Key)"TimeLimitedExtension_End", 1.0 );
    vel = Dictionary_GetDouble_WithDefault(
        dictionary, (Dictionary_Entry_Key)"TimeLimitedExtension_Velocity",
        1.0 );
    ...
    if( context->currentTime > endTime )
        *result = 0.0;
        ...
        Grid_Lift( grid, FeMesh_NodeDomainToGlobal( mesh, node_lI ), param );
        if( param[0] == 0 )
            *result = -vel;
        else
            *result = vel;
...
void StgFEM_StandardConditionFunctions_ParabolicProfile2D(Node_LocalIndex node_lI,Variable_Index var_I,void *_context,void* _data, void* _result) 
{
	...
	double        *result     = (double*) _result;
	double        *coord;
	double        vy,r_coord,A_0,r_0,r_origin,r_max;
	
	feVariable = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "VelocityField" );
	mesh       = feVariable->feMesh;
	
	/* Find Centre of Solid Body Rotation */
	A_0      = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_A0",      0.0 );
	r_0      = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_r0",      1.0 );
	r_origin = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_rOrigin", 0.5 );
	r_max    = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_rMax",    1.0 );
	
	/* Find coordinate of node */
	coord = Mesh_GetVertex( mesh, node_lI );
	
	r_coord = coord[ I_AXIS ];
	vy = 0.0;
	if ( fabs(r_coord-r_origin) <= r_max ) {
		vy = A_0 * ( r_0*r_0 - (r_coord-r_origin)*(r_coord-r_origin) );
	}
...
void StgFEM_StandardConditionFunctions_ParabolicProfile3D(Node_LocalIndex node_lI,Variable_Index var_I,void *_context,void* _data, void* _result)
{
	...
	double        *result     = (double*) _result;
	double        *coord;
	double        vy,r_coord,coordX,coordZ,A_0,r_0,r_originX,r_originZ,r_max;
	...
	A_0       = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_A0",      0.0 );
	r_0       = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_r0",      1.0 );
	r_originX = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_rOriginX", 0.5 );
	r_originZ = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_rOriginZ", 0.5 );
	r_max     = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"ParabolicProfile_rMax",    1.0 );
	...
	coordZ = coord[ K_AXIS ];
	vy = 0.0;
	r_coord = sqrt( (coordX-r_originX)*(coordX-r_originX) + (coordZ-r_originZ)*(coordZ-r_originZ) );
	if ( r_coord <= r_max ) {
		vy = A_0 * ( r_0*r_0 - r_coord*r_coord );
	}
...
void StgFEM_StandardConditionFunctions_StepProfile2D(Node_LocalIndex node_lI,Variable_Index var_I,void *_context,void* _data, void* _result) 
{
	...
	double        *result     = (double*) _result;
	double        *coord;
	double        vy,r_coord,V_S,r_0,r_origin,r_max;
	
	feVariable = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "VelocityField" );
	mesh       = feVariable->feMesh;
	
	/* Find Centre of Solid Body Rotation */
	V_S      = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile2D_VS",      0.0 );
	r_0      = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile2D_r0",      1.0 );
	r_origin = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile2D_rOrigin", 0.5 );
	r_max    = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile2D_rMax",    1.0 );
...
void StgFEM_StandardConditionFunctions_StepProfile3D(Node_LocalIndex node_lI,Variable_Index var_I,void *_context,void* _data, void* _result)
{
	...
	double        *result     = (double*) _result;
	double        *coord;
	double        vy,r_coord,coordX,coordZ,V_S,r_0,r_originX,r_originZ,r_max;
	
	feVariable = (FeVariable*)FieldVariable_Register_GetByName( context->fieldVariable_Register, "VelocityField" );
	mesh       = feVariable->feMesh;
	
	/* Find Centre of Solid Body Rotation */
	V_S       = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile3D_VS",      0.0 );
	r_0       = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile3D_r0",      1.0 );
	r_originX = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile3D_rOriginX", 0.5 );
	r_originZ = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile3D_rOriginZ", 0.5 );
	r_max     = Dictionary_GetDouble_WithDefault( dictionary, (Dictionary_Entry_Key)"StepProfile3D_rMax",    1.0 );
