...
/** \file
**  Role:
**   Shortcuts to complex types in the eyes of the FE user.
**
** Assumptions:
**   None as yet.
**
...
#define __StgFEM_Discretisation_shortcuts_h__
   ...
   /* Field shortcuts */
   #define SetValueAtNode( dofLayout, dNode_I, componentValues ) \
      do { \
         Dof_Index dofCountThisNode = 0; \
         Dof_Index nodeLocalDof_I = 0; \
         \
         dofCountThisNode = dofLayout->dofCounts[dNode_I]; \
         \
         for( nodeLocalDof_I = 0; nodeLocalDof_I < dofCountThisNode; nodeLocalDof_I++ ) { \
            ...
            dNode_I, \
            nodeLocalDof_I, \
            componentValues[nodeLocalDof_I] ); \
         } \
      } while(0)
