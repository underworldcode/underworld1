...
#ifndef __Geothermal_DarcyConditionFunction_h__
#define __Geothermal_DarcyConditionFunction_h__

extern const Type Geothermal_DarcyConditionFunction_Type;

typedef struct {
	__Codelet
	
} Geothermal_DarcyConditionFunction;

Index Geothermal_DarcyConditionFunction_Register( PluginsManager* pluginsManager );

void Geothermal_SourceSinkConditionFunction_getVal( Node_LocalIndex node_lI, Variable_Index var_I, void* _context, void* data, void* _result );
